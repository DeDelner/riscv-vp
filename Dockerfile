...
#RUN su - riscv-vp -c 'echo export PATH=\"$PATH:/workspaces/riscv-vp/vp/build/bin\" >> /workspaces/riscv-vp/.profile'
RUN export PATH=$PATH:/workspaces/riscv-vp/vp/build/bin
CMD su - riscv-vp
